                ...
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8">
                    <div class="form-container">
                        ...
                        <form class="form-horizontal" action="" method="POST">
                            <h3 class="title">Registration Admin</h3>
                            ...
                            <div class="form-group">
                                <span class="input-icon"><i class="fa fa-lock"></i></span>
                                <label for="password" class="form-control-label">Repeat Password</label>
                                <input type="password" name="password2" id="password2" class="form-control" require placeholder="repeat password">
                            </div>
                            <button name="register" class="btn signin">Daftar!</button>
                        </form>
                    </div>
                </div>
            </div>
